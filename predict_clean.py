...
def build_and_restore(model_cls, model_dir: str):
...
def main(args):
    ...
    print("decoding...")
    lm = LanguageModelKen(lm=kenlm.Model(infer_moder_dir('kneser-ney/model.arpa', val_mode=args.val_mode)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_mode', action='store_false',
